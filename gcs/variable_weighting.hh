...
namespace gcs
{
    ...
    public:
         ...
         * filter).
         */
        [[nodiscard]] virtual auto weighted_degree_of(
            const CurrentState & state, const innards::Propagators & propagators, IntegerVariableID var) const -> double = 0;
    ...
    {
    public:
        [[nodiscard]] auto weighted_degree_of(const CurrentState & state, const innards::Propagators & propagators, IntegerVariableID var) const
            -> double override;
    ...
    public:
        ...
        auto note_conflict(int constraint_index, const std::vector<SimpleIntegerVariableID> & scope, const std::optional<innards::Reason> & reason,
            const innards::State & state) -> void override;
