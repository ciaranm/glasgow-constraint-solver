...
Nogoods::Nogoods(vector<Nogood> nogoods) : _store(make_shared<NogoodStore>())
{
...
Nogoods::Nogoods(shared_ptr<NogoodStore> store, vector<IntegerVariableID> trigger_vars) : _store(move(store)), _trigger_vars(move(trigger_vars))
{
}
