...
auto main(int argc, char * argv[]) -> int
{
    ...
    vector<tuple<pair<int, int>, pair<int, int>, vector<pair<int, int>>>> var_data = {{{1, 2}, {0, 1}, {{1, 2}, {1, 2}}},
        {{1, 2}, {-2, 2}, {{1, 2}, {1, 2}}}, {{1, 2}, {0, 1}, {{1, 2}, {1, 2}, {1, 2}}}, {{-1, 3}, {0, 2}, {{-1, 2}, {1, 3}, {4, 5}}},
        {{1, 4}, {0, 4}, {{1, 4}, {2, 3}, {0, 5}, {-2, 0}, {5, 7}}}, {{-5, 5}, {-3, 2}, {{-8, 0}, {4, 4}, {10, 10}, {2, 11}, {4, 10}}},
    ...
    vector<tuple<pair<int, int>, pair<int, int>, vector<int>>> const_data = {{{1, 2}, {1, 2}, {1, 2}}, {{1, 2}, {0, 1}, {1, 2}},
        {{1, 2}, {0, 2}, {1, 2, 2}}, {{1, 2}, {0, 2}, {1, 2, 5}}, {{-4, 6}, {-3, 3}, {-7, 2, -4, -10}},
    ...
    vector<tuple<pair<int, int>, pair<int, int>, pair<int, int>, vector<vector<int>>>> const2d_data = {{{1, 2}, {1, 2}, {1, 2}, {{1, 2}, {1, 2}}},
        {{1, 2}, {0, 1}, {1, 2}, {{1, 2}, {1, 2}}}, {{1, 8}, {0, 3}, {0, 3}, {{1, 5}, {7, 9}, {3, 6}}},
