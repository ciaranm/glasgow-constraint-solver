...
auto Element2DConstantArray::install(Propagators & propagators, const State & initial_state) && -> void
{
    ...
    propagators.propagator(initial_state, [idx1 = _idx1, idx2 = _idx2, var = _var, vals = _vals, idxsel = move(idxsel)] (
    ...
    propagators.propagator(initial_state, [idx1 = _idx1, idx2 = _idx2, var = _var, vals = _vals] (
