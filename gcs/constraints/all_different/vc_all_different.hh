...
{
    auto propagate_non_gac_alldifferent(const ConstraintStateHandle & unassigned_handle, State & state) -> innards::Inference;

    auto define_clique_not_equals_encoding(gcs::innards::State & state, Propagators & propagators, const std::vector<IntegerVariableID> & vars) -> void;
}
