...
auto main(int, char *[]) -> int
{
    ...
    data.emplace_back(pair{ 3, 8 }, pair{ -4, 7 }, pair{ 2, 5 }, vector{
    ...
    data.emplace_back(pair{ -3, 5 }, pair{ -3, 5 }, pair{ -2, 5 }, vector{
        pair{ vector{ 2, 3, 4 }, 20 },
        pair{ vector{ -1, -3, 0 }, -5 },
        pair{ vector{ 0, 4, 2 }, 6 } });

    data.emplace_back(pair{ 7, 9 }, pair{ -7, 0 }, pair{ 4, 8 }, vector{
        pair{ vector{ -3, 3, -5 }, -62 },
        pair{ vector{ 3, 4, 3 }, 197 } });

    data.emplace_back(pair{ 3, 4 }, pair{ 8, 12 }, pair{ 5, 13 }, vector{
    ...
    data.emplace_back(pair{ -7, -6 }, pair{ -9, -2 }, pair{ -4, 3 }, vector{
