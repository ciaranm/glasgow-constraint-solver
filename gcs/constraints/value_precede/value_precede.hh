#ifndef GLASGOW_CONSTRAINT_SOLVER_GUARD_GCS_CONSTRAINTS_VALUE_PRECEDE_VALUE_PRECEDE_HH
#define GLASGOW_CONSTRAINT_SOLVER_GUARD_GCS_CONSTRAINTS_VALUE_PRECEDE_VALUE_PRECEDE_HH
