...
namespace gcs::innards
{
    ...
    public:
         ...
         */
        auto install(PropagationFunction &&, const std::vector<std::variant<IntegerVariableID, std::vector<IntegerVariableID>, Literal>> & all_variables,
            const Triggers & trigger_vars, const std::string & name) -> void;
