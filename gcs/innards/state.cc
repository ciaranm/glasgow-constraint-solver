...
{
    return overloaded{
        [&](const reif::MustHold &) -> EvaluatedReificationCondition { return evaluated_reif::MustHold{nullopt}; },
        [&](const reif::MustNotHold &) -> EvaluatedReificationCondition { return evaluated_reif::MustNotHold{nullopt}; },
        [&](const reif::If & cond) -> EvaluatedReificationCondition {
            ...
            case LiteralIs::DefinitelyFalse: return evaluated_reif::Deactivated{cond.cond};
