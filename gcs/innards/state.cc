...
template <IntegerVariableIDLike VarType_>
auto State::each_value(const VarType_ & var) const -> generator<Integer>
{
    auto [actual_var, negate_first, then_add] = deview(var);
...
namespace gcs
{
    ...
    template auto State::each_value(const IntegerVariableID &) const -> generator<Integer>;
    template auto State::each_value(const SimpleIntegerVariableID &) const -> generator<Integer>;
    template auto State::each_value(const ViewOfIntegerVariableID &) const -> generator<Integer>;
    template auto State::each_value(const ConstantIntegerVariableID &) const -> generator<Integer>;
