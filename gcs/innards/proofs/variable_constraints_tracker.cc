...
auto VariableConstraintsTracker::get_bit(const gcs::innards::SimpleOrProofOnlyIntegerVariableID & var, unsigned long position) -> std::pair<Integer, XLiteral>
{
...
auto VariableConstraintsTracker::get_bit(const ProofBitVariable & bit) -> std::pair<Integer, XLiteral>
{
