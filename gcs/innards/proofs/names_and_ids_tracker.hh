...
namespace gcs::innards
{
    ...
    public:
         ...
         */
        [[nodiscard]] auto need_pol_item_defining_literal(const IntegerVariableCondition &) -> boost::variant2::variant<ProofLine, XLiteral>;
        ...
        auto track_eqvar(SimpleIntegerVariableID, Integer,
            const std::pair<boost::variant2::variant<ProofLine, XLiteral>, boost::variant2::variant<ProofLine, XLiteral>> &) -> void;
