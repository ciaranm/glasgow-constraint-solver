...
namespace
{
    ...
    {
        auto items = [](size_t count, int hi) {
            return vector<std::pair<Integer, Integer>>(count, {0_i, Integer{hi}});
        };
        switch (n) {
        case 1:
        ...
        case 3:
            ...
            return Instance{
                "i3_12_4bins_capa_wide",
                {1_i, 2_i, 3_i, 4_i, 5_i, 2_i, 3_i, 4_i, 1_i, 2_i, 5_i, 3_i},
                items(12, 3),
                vector<Integer>{12_i, 12_i, 12_i, 12_i}};
        case 4:
            // 12 items / 4 bins variable-load, wider cap.
            return Instance{
                "i4_12_4bins_load_wide",
                {1_i, 2_i, 3_i, 4_i, 5_i, 2_i, 3_i, 4_i, 1_i, 2_i, 5_i, 3_i},
                items(12, 3),
        ...
        case 5:
            ...
            return Instance{
                "i5_8_2bins_tight_capa",
                {3_i, 5_i, 2_i, 4_i, 3_i, 4_i, 2_i, 5_i},
                items(8, 1),
                vector<Integer>{14_i, 14_i}};
        case 6:
            // Wide-size constant-cap, exercises the DAG horizontally.
            return Instance{
                "i6_8_2bins_widesizes_capa",
                {1_i, 2_i, 4_i, 7_i, 1_i, 3_i, 5_i, 6_i},
                items(8, 1),
                vector<Integer>{15_i, 15_i}};
        default:
...
auto main(int argc, char * argv[]) -> int
{
    ...
    for (size_t i = 0; i < inst.item_ranges.size(); ++i)
        items.push_back(p.create_integer_variable(inst.item_ranges[i].first, inst.item_ranges[i].second,
    ...
    if (std::holds_alternative<vector<std::pair<Integer, Integer>>>(inst.bins)) {
        ...
        for (size_t b = 0; b < loads_bounds.size(); ++b)
            loads.push_back(p.create_integer_variable(loads_bounds[b].first, loads_bounds[b].second,
                "load" + std::to_string(b)));
